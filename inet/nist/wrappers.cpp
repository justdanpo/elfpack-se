...
int WSocket::Connect(sockaddr* addr)
{
...
int WSocketUtility::MakeSocketIpv4Address(in_addr* sin_addr, wchar_t nPortNetworkOrder, sockaddr* socketAddress)
{
	WSOCKETUTILMETHOD(MakeSocketIpv4Address, sin_addr, nPortNetworkOrder, socketAddress);
}

int WSocketUtility::MakeSocketIpv6Address(in6_addr* sin_addr, wchar_t nPortNetworkOrder, unsigned long sin6_flowinfo, unsigned long sin6_scope_id, sockaddr* socketAddress)
{
	WSOCKETUTILMETHOD(MakeSocketIpv6Address, sin_addr, nPortNetworkOrder, sin6_flowinfo, sin6_scope_id, socketAddress);
}

int WSocketUtility::MakeSocketAddress(sockaddr_short* sockAddress, wchar_t nPortNetworkOrder, sockaddr* socketAddress)
{
