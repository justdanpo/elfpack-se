...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x10D8D458+1
        defadr   DB_PATCH_RET,0x117DC4D8+1
        defadr   DB_EXT_RET,0x117DC2E0+1
        defadr   DB_PATCH3_RET,0x117DC188+1
        defadr   DB_PATCH4_RET,0x117DCB56+1
        defadr   DB_PATCH5_RET,0x117DC32C+1
        defadr   DB_PATCH6_RET,0x117DC360+1
        defadr   MESS_HOOK_RET,0x1120E0C0+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x109C6B0C+1
	defadr   KEY_HOOK_TIMER_RETUN,0x109C6B72+1

        defadr  memalloc,0x4BB00584
        defadr  memfree,0x4BB005AC
        defadr  Timer_Set,0x10DECD0D
