...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x1444D3C0+1
        defadr   DB_PATCH1_RET,0x144DC2F0+1
        defadr   DB_PATCH2_RET,0x144DBEFC+1
        defadr   DB_PATCH3_RET,0x14EF8AC4+1
        defadr   DB_PATCH4_RET,0x14424384+1
        defadr   MESS_HOOK_RET,0x10134318+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x142EB140+1
	defadr   KEY_HOOK_TIMER_RETUN,0x142EB1B0+1

        defadr  memalloc,0x4BA31878
        defadr  memfree,0x4BA318A0
        defadr  Timer_Set,0x14503355
