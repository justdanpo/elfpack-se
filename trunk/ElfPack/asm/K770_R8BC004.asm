...
TABMENUBAR_NAME EQU 0x45CDBD84
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x453F7760+1
        defadr   DB_PATCH_RET,0x44FEDABC+1
        defadr   DB_EXT_RET,0x44FED8A8+1
        defadr   DB_PATCH3_RET,0x44FED748+1
        defadr   DB_PATCH4_RET,0x44FEE110+1
        defadr   MESS_HOOK_RET,0x448EF410+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x4548C446+1
	defadr   KEY_HOOK_TIMER_RETUN,0x4548C4A2+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x4548C46C+1

        defadr  memalloc,0x44E7FDD0+1
        defadr  memfree,0x44E7FDFC+1
        defadr  Timer_Set,0x453E1355
