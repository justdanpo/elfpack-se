...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x45424A4C+1
        defadr   DB_PATCH_RET,0x4500EB6C+1
        defadr   DB_EXT_RET,0x4500E958+1
        defadr   DB_PATCH3_RET,0x4500E7F8+1
        defadr   DB_PATCH4_RET,0x4500F1C0+1
        defadr   MESS_HOOK_RET,0x44910C7C+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x454B9912+1
	defadr   KEY_HOOK_TIMER_RETUN,0x454B996E+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x454B9938+1

        defadr   memalloc,0x44BEE104+1
        defadr   memfree,0x44BEE130+1
        defadr  Timer_Set,0x4540E569
