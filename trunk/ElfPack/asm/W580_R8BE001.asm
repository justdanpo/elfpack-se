...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x452C1640+1
        defadr   DB_PATCH_RET,0x44EB02B0+1
        defadr   DB_EXT_RET,0x44EB009C+1
        defadr   DB_PATCH3_RET,0x44EAFF3C+1
        defadr   DB_PATCH4_RET,0x44EB0904+1
        defadr   MESS_HOOK_RET,0x447AD348+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x4535757E+1
	defadr   KEY_HOOK_TIMER_RETUN,0x453575DA+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x453575A4+1

        defadr  memalloc,0x44D432A4+1
        defadr  memfree,0x44D432D0+1
        defadr  Timer_Set,0x452AB405
