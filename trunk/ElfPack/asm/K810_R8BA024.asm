...
TABMENUBAR_NAME EQU 0x45C74720
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x453CC1FC+1
        defadr   DB_PATCH_RET,0x44FC5AC4+1
        defadr   DB_EXT_RET,0x44FC58B0+1
        defadr   DB_PATCH3_RET,0x44FC5750+1
        defadr   DB_PATCH4_RET,0x44FC6118+1
        defadr   MESS_HOOK_RET,0x448FAA50+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x45460E32+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45460E8E+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x45460E58+1

        defadr  memalloc,0x44BB0F08+1
        defadr  memfree,0x44BB0F34+1
        defadr  Timer_Set,0x453B5DF5
