...
TABMENUBAR_NAME EQU 0x45C60744
...
a       EQU     b
	...
	defadr   KEY_HOOK_REPEAT_RETUN,0x454565BA+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45456616+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x454565E0+1

        defadr  memalloc,0x44E4FD44+1
        defadr  memfree,0x44E4FD70+1
        defadr  Timer_Set,0x453AB581
