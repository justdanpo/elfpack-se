...
TABMENUBAR_NAME EQU 0x45BDE1A4
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x452FD1F4+1
        defadr   DB_PATCH_RET,0x44EE5278+1
        defadr   DB_EXT_RET,0x44EE5064+1
        defadr   DB_PATCH3_RET,0x44EE4F04+1
        defadr   DB_PATCH4_RET,0x44EE58CC+1
        defadr   MESS_HOOK_RET,0x447D5F5C+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x45392F6A+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45392FC6+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x45392F90+1

        defadr  memalloc,0x44D77D68+1
        defadr  memfree,0x44D77D94+1
        defadr  Timer_Set,0x452E6F81
