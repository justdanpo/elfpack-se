...
TABMENUBAR_NAME EQU 0x45A60AFC
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x452BE050+1
        defadr   DB_PATCH_RET,0x44EBC118+1
        defadr   DB_EXT_RET,0x44EBBF04+1
        defadr   DB_PATCH3_RET,0x44EBBDA4+1
        defadr   DB_PATCH4_RET,0x44EBC76C+1
        defadr   MESS_HOOK_RET,0x447C7E28+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x4535329A+1
	defadr   KEY_HOOK_TIMER_RETUN,0x453532F6+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x453532C0+1

        defadr  memalloc,0x44D507E4+1
        defadr  memfree,0x44D50810+1
        defadr  Timer_Set,0x452A7DBD
