...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x10D64F98+1
        defadr   DB_PATCH_RET,0x117B87F4+1
        defadr   DB_EXT_RET,0x117B85FC+1
        defadr   DB_PATCH3_RET,0x117B84A4+1
        defadr   DB_PATCH4_RET,0x117B8E72+1
        defadr   DB_PATCH5_RET,0x117B8648+1
        defadr   DB_PATCH6_RET,0x117B867C+1
        defadr   MESS_HOOK_RET,0x111E834C+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x1099FA30+1
	defadr   KEY_HOOK_TIMER_RETUN,0x1099FA96+1

        defadr  memalloc,0x4BB00584
        defadr  memfree,0x4BB005AC
        defadr  Timer_Set,0x10DC4431
