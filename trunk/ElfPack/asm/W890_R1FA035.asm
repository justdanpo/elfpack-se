...
a       EQU     b
	...
	defadr   KEY_HOOK_REPEAT_RETUN,0x116DA872+1
	defadr   KEY_HOOK_TIMER_RETUN,0x116DA8D8+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x116DA898+1

        defadr  memalloc,0x1109D078+1
        defadr  memfree,0x1109D088+1
        defadr  Timer_Set,0x11642681
