...
TABMENUBAR_NAME EQU 0x45CD8D24
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x453F5BB8+1
        defadr   DB_PATCH_RET,0x44FECDE4+1
        defadr   DB_EXT_RET,0x44FECBD0+1
        defadr   DB_PATCH3_RET,0x44FECA70+1
        defadr   DB_PATCH4_RET,0x44FED438+1
        defadr   MESS_HOOK_RET,0x448FA884+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x4548A8A2+1
	defadr   KEY_HOOK_TIMER_RETUN,0x4548A8FE+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x4548A8C8+1

        defadr  memalloc,0x44E7F144+1
        defadr  memfree,0x44E7F170+1
        defadr  Timer_Set,0x453DF7A5
