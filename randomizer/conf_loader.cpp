...
#define CONFIGNAME L"randomizer.bcfg"
...
{
	if ( LoadConfigData( GetDir( DIR_ELFS_CONFIG|MEM_EXTERNAL ), CONFIGNAME ) < 0 )
	{
		LoadConfigData( GetDir( DIR_ELFS_CONFIG|MEM_INTERNAL ), CONFIGNAME );
	}
}
