...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x10D71588+1
        defadr   DB_PATCH_RET,0x117CA91C+1
        defadr   DB_EXT_RET,0x117CA724+1
        defadr   DB_PATCH3_RET,0x117CA5CC+1
        defadr   DB_PATCH4_RET,0x117CAF9A+1
        defadr   DB_PATCH5_RET,0x117CA770+1
        defadr   DB_PATCH6_RET,0x117CA7A4+1
        defadr   MESS_HOOK_RET,0x111F5D3C+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x109A7A08+1
	defadr   KEY_HOOK_TIMER_RETUN,0x109A7A6E+1

        defadr  memalloc,0x4BB00584
        defadr  memfree,0x4BB005AC
        defadr  Timer_Set,0x10DD0A29
