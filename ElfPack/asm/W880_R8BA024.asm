...
a	EQU	b
	...
	defadr   KEY_HOOK_REPEAT_RETUN,0x4546EB46+1
	defadr   KEY_HOOK_TIMER_RETUN,0x4546EBA2+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x4546EB6C+1

        defadr  memalloc,0x450673F4+1
        defadr  memfree,0x45067420+1
        defadr  Timer_Set,0x453C3841
