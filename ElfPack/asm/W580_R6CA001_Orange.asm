...
TABMENUBAR_NAME EQU 0x45BBDE08
...
a       EQU     b
	...
	defadr   KEY_HOOK_REPEAT_RETUN,0x45384C7E+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45384CDA+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x45384CA4+1

        defadr  memalloc,0x44EE81EC+1
        defadr  memfree,0x44EE8218+1
        defadr  Timer_Set,0x452D8F09
