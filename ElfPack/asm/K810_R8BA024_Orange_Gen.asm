...
TABMENUBAR_NAME EQU 0x45CA4AE0
...
a       EQU     b
	...
	defadr   KEY_HOOK_REPEAT_RETUN,0x4549C6E2+1
	defadr   KEY_HOOK_TIMER_RETUN,0x4549C73E+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x4549C708+1
