...
a       EQU     b
	...
	defadr   KEY_HOOK_REPEAT_RETUN,0x4547798A+1
	defadr   KEY_HOOK_TIMER_RETUN,0x454779E6+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x454779B0+1

        defadr  memalloc,0x44FE5018+1
        defadr  memfree,0x44FE5044+1
        defadr  Timer_Set,0x453CC38D
