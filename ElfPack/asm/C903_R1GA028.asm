...
a       EQU     b
        ...
        RSEG  CODE
        defadr   DB_PATCH_RET,0x142DAE48+1
        defadr   DB_EXT_RET,0x142DAA50+1
        defadr   DB_PATCH3_RET,0x14FCBF6C+1
        defadr   DB_PATCH4_RET,0x14FA33D8+1
        defadr   MESS_HOOK_RET,0x101369F0+1
