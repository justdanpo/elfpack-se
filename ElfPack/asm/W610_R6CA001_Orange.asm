...
TABMENUBAR_NAME EQU 0x45A80F8C
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x452EDC20+1
        defadr   DB_PATCH_RET,0x44EE7B2C+1
        defadr   DB_EXT_RET,0x44EE7918+1
        defadr   DB_PATCH3_RET,0x44EE77B8+1
        defadr   DB_PATCH4_RET,0x44EE8180+1
        defadr   MESS_HOOK_RET,0x447CDD7C+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x45382AB2+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45382B0E+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x45382AD8+1

        defadr  memalloc,0x44D7C2D8+1
        defadr  memfree,0x44D7C304+1
        defadr  Timer_Set,0x452D7A41
