...
a       EQU     b
        ...
        RSEG  CODE
        defadr   DB_PATCH1_RET,0x144DBAB4+1
        defadr   DB_PATCH2_RET,0x144DB6C0+1
        defadr   DB_PATCH3_RET,0x14F57368+1
        defadr   DB_PATCH4_RET,0x14423C5C+1
        defadr   MESS_HOOK_RET,0x101330CC+1
