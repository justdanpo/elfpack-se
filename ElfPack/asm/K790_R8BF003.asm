...
TABMENUBAR_NAME EQU 0x45AC954C
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x4527DB3C+1
        defadr   DB_PATCH_RET,0x44E8A5C0+1
        defadr   DB_EXT_RET,0x44E8A3AC+1
        defadr   DB_PATCH3_RET,0x44E8A24C+1
        defadr   DB_PATCH4_RET,0x44E8AC14+1
        defadr   MESS_HOOK_RET,0x447B2D1C+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x453126F6+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45312752+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x4531271C+1

        defadr  memalloc,0x44A7863C+1
        defadr  memfree,0x44A78668+1
        defadr  Timer_Set,0x452678B9
