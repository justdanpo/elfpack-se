...
TABMENUBAR_NAME EQU 0x45C77348
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x453CDE08+1
        defadr   DB_PATCH_RET,0x44FC684C+1
        defadr   DB_EXT_RET,0x44FC6638+1
        defadr   DB_PATCH3_RET,0x44FC64D8+1
        defadr   DB_PATCH4_RET,0x44FC6EA0+1
        defadr   MESS_HOOK_RET,0x448EF914+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x45462A4E+1
	defadr   KEY_HOOK_TIMER_RETUN,0x45462AAA+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x45462A74+1

        defadr  memalloc,0x44BB1810+1
        defadr  memfree,0x44BB183C+1
        defadr  Timer_Set,0x453B7A19
